                ...
                <div className="navigation-container">
                  ...
                  <div className="navigation-left"></div>
                   ...
                   <nav role="navigation" className="nav-menu w-nav-menu">
                    <a href="#" onClick={() => scrollToSection(featureSectionRef)} className="navbar-link w-nav-link">Features</a>
              ...
              <div className="container-large">
                <div className="padding-section-large">
                  ...
                  <motion.div whileInView={{ opacity: 1, y: 0 }}
                       ...
                       viewport={{ once: true }} data-w-id="d44de844-0ea8-9efd-4483-5c9b677cc1c6" className="w-layout-grid layout-component-dark">
                  ...
                  <div className="w-layout-grid _2-column-grid">
                    ...
                    <motion.div whileInView={{ opacity: 1, y: 0 }}
                                initial={{ opacity: 0, y: 50 }}
                                transition={{ duration: 1.0, ease: "easeInOut" }}
                                viewport={{ once: true }} id="w-node-d44de844-0ea8-9efd-4483-5c9b677cc1d3-677cc1bb" data-w-id="d44de844-0ea8-9efd-4483-5c9b677cc1d3" className="layout-card-gray">
                      <div className="layout-card-content-top">
                        <div className="margin-bottom">
                    ...
                    <motion.div whileInView={{ opacity: 1, y: 0 }}
                                initial={{ opacity: 0, y: 50 }}
                                transition={{ duration: 1.0, ease: "easeInOut" }}
                                viewport={{ once: true }} id="w-node-d44de844-0ea8-9efd-4483-5c9b677cc1dd-677cc1bb" data-w-id="d44de844-0ea8-9efd-4483-5c9b677cc1dd" className="layout-card-blue">
                      <div className="layout-card-content-top">
                        <div className="margin-bottom">
                  ...
                  <div data-w-id="d44de844-0ea8-9efd-4483-5c9b677cc1e7"
                    ...
                    <motion.div whileInView={{ opacity: 1, y: 0 }}
                                ...
                                viewport={{ once: true }} data-w-id="d44de844-0ea8-9efd-4483-5c9b677cc1e8" className="layout-card-gray-horizontal">
