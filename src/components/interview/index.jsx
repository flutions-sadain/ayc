                ...
                <div className="relative isolate h-auto">
                    <div className="mx-auto w-full md:w-3/4 lg:w-2/3 xl:w-1/2 bg-white my-10 rounded-3xl shadow-xl">
                        <div className="relative min-w-full place-items-center py-24 sm:py-20 lg:py-10 px-5 md:px-10">
                            ...
                            {/* <motion.div className={(wizard === 'interviewInstructions' && interviewPageNo === 2) ? 'visible' : 'hidden'} initial={{ x: '0' }} aria-label="User Onboarding">
                                <div className="relative pb-4">
                                    <div className="relative flex items-center md:items-start md:space-x-6">
                                        <div className="relative -ml-2">
                            ...
                            <motion.div className='visible' initial={{ x: '0' }} aria-label="Interview component">
                                <InterviewForm />
                            </motion.div>
                            {/* <motion.div className={(wizard === 'interviewInstructions' && interviewPageNo === 2) ? "visible" : "hidden"} initial={{ x: '0' }} aria-label="Professional Profile contact component">
                                <UserDetailsForm setInterviewPageNo={setInterviewPageNo} />
                            </motion.div> */}
                        </div>
                    </div>
                </div>
