    ...
    return (
        <>
            ...
            <motion.section whileInView={{opacity: 1, y: 0}} // Target animation
                            ...
                            viewport={{once: true}} // Ensures animation runs only once
                            ref={featureSectionRef} className="background-color-gray">
                        ...
                        <div className="padding-section-large">
                            <div className="margin-bottom">
                                <div className="align-center">
                                    <div data-w-id="d44de844-0ea8-9efd-4483-5c9b677cc1c1"
                                         className="text-highlight">Our Mission
                                    </div>
                                </div>
                            </div>
                            <div className="margin-bottom">
                                <p
                                    className="text-size-large text-align-center max-width-full">Our mission is
                                    straightforward yet ambitious: to empower individuals across the globe to unlock
                                    their full professional potential. We strive to make career advancement accessible,
                                    effective, and personalized. By harnessing the power of artificial intelligence and
                                    a comprehensive suite of tools, we aim to guide you through every step of your
                                    career journey - from discovering your ideal career path to mastering the skills
                                    needed to excel.</p>
                            </div>
                    ...
                    <div className="padding-section-large">
                            ...
                            <div className="margin-bottom margin-large">
                                <h2 data-w-id="aec0b6d2-398a-fb3c-88c4-d4173188ea22"
                                    className="heading-style-h2 text-align-center text-color-white">What sets Us Apart</h2>
                            </div>
                            <div className="w-layout-grid core-features-grid">
                                <div id="w-node-aec0b6d2-398a-fb3c-88c4-d4173188ea25-3188ea19"
                                    ...
                                    <div className="margin-bottom"><img src="images/Icon1.svg" loading="lazy" width="48"
                                                                        alt=""/>
                                    </div>
                                    <div className="margin-bottom">
                                        <h5 className="heading-style-h5 text-color-white">
                                            Personalized Experience</h5>
                                    </div>
                                    <div className="margin-bottom">
                                        <p className="text-size-medium text-color-gray">Every aspect of AYC is designed with you in mind. Our platform offers tailored advice, courses, and career development tools that align with your personal goals and industry trends</p>
                                    </div>
                                </div>
                                <div data-w-id="aec0b6d2-398a-fb3c-88c4-d4173188ea2e" className="resource-item">
                                    <div className="margin-bottom"><img src="images/Icon2.svg" loading="lazy" width="48"
                                                                        alt=""/>
                                    </div>
                                    <div className="margin-bottom">
                                        <h5 className="heading-style-h5 text-color-white">AI-Powered Insights</h5>
                                    </div>
                                    <div className="margin-bottom">
                                        <p className="text-size-medium text-color-gray">We leverage advanced AI algorithms to provide you with insights into your skills, potential career paths, and the latest market trends, ensuring you're always prepared for the future of work</p>
                                    </div>
                                </div>
                                <div id="w-node-aec0b6d2-398a-fb3c-88c4-d4173188ea37-3188ea19"
                                    ...
                                    <div className="margin-bottom"><img src="images/Icon3.svg" loading="lazy" width="48"
                                                                        alt=""/>
                                    </div>
                                    <div className="margin-bottom">
                                        <h5 className="heading-style-h5 text-color-white">Comprehensive Resources</h5>
                                    </div>
                                    <div className="margin-bottom">
                                        <p className="text-size-medium text-color-gray">From our interview simulator and resume builder to a curated library of courses and articles, AYC provides all the resources you need to advance your career in one place</p>
                                    </div>
                                </div>
                                <div data-w-id="aec0b6d2-398a-fb3c-88c4-d4173188ea40" className="resource-item">
                                    <div className="margin-bottom"><img src="images/Icon4.svg" loading="lazy" width="48"
                                                                        alt=""/>
                                    </div>
                                    <div className="margin-bottom">
                                        <h5 className="heading-style-h5 text-color-white">Commitment to Excellence</h5>
                                    </div>
                                    <div className="margin-bottom">
                                        <p className="text-size-medium text-color-gray"> We are continuously evolving, adding new features and content to ensure you have access to the best possible tools and resources for your career development</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="padding-section-small">
                            <div className="w-layout-grid grid ">
                                <div id="w-node-ee172e5d-ad0e-331c-51dd-00304570e1b7-4570e1b2" className="content-info">
                                    <h2 className="heading-style-h2">Join Us on Your Career Journey </h2>
                                    <p>
                                        Whether you're looking to make a career change, climb the corporate ladder, or simply enhance your skills, AYC is here to support you every step of the way. Together, let's unlock your potential and advance your career to new heights.
                                    </p>
                                    <a href="#" className="button w-button">Join Our Waitlist</a>
                                </div>
                                <div id="w-node-ee172e5d-ad0e-331c-51dd-00304570e1be-4570e1b2"
                                     className="image-wrapper cta"></div>
                            </div>
                        </div>
                    </div>
                </div>
