        ...
        <div>
            <section className="h-[200px] bg-blue-600">
                <div className="py-5 sm:px-6 lg:px-0 lg:py-5">
                    <h1 className="text-white text-center text-4xl mb-2 text-[gt-bold]">Assessment Score</h1>
                    <div className="absolute inset-0 flex justify-center items-center transform translate-y-[16rem] sm:translate-y-[12rem] md:translate-y-[6rem] lg:-translate-y-10">
                        <div className="lg:flex mb-6 bg-white shadow-md rounded-lg overflow-hidden border border-gray-300 p-2 z-10">
                            <div class="p-2 text-center md:mx-auto md:w-[50%] lg:w-[30%]">
                                <p className="text-2xl max-sm:text-xl font-[gt-bold]">Element of Evaluation</p>
                                <div className='relative'>
                                    <svg class="size-full mx-auto mt-3 w-3/4 h-3/4" width="36" height="36" viewBox="0 0 36 36" xmlns="http://www.w3.org/2000/svg">
                                        <circle cx="18" cy="18" r="16" fill="none" class="stroke-current text-blue-600" stroke-width="3"></circle>
            ...
            <div className="xl:mx-40 sm:mx-10 mt-[52rem] sm:mt-[42rem] md:mt-[30rem] lg:mt-52 xl:mt-56 mb-10">
