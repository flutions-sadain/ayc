                ...
                <div class="py-16 sm:px-4 lg:relative lg:px-0 lg:py-5">
                    <div class="xl:mx-64 items-center px-4 xl:px-12">
                        <div class="relative z-10">
                            ...
                            <div class="relative">
                                <p class="mt-3 text-2xl font-light font-[gt-light] text-black">Tell us more, so that we can find the <span className="font-medium font-[gt-bold]">right curriculum & Mentor for you</span></p>
                            </div>
                            <div className="lg:mx-20 mt-5">
                                <form onSubmit={submit}>
                                    <div className="p-2 w-full">
                                        <div className="relative">
                                            <label htmlFor="Employer" className="leading-7 text-lg font-[gt-regular] text-black">
                                    ...
                                    <div className="p-2 w-full">
                                        <div className="relative">
                                            <label htmlFor="role" className="leading-7 text-lg font-[gt-regular] text-black">
                                    ...
                                    <div className="p-2 w-full">
                                        <div className="relative">
                                            <label htmlFor="ctc" className="leading-7 text-lg font-[gt-regular] text-black" >
                                    ...
                                    <div className="p-2 w-full">
                                        <div className="relative">
                                            <label htmlFor="college" className="leading-7 text-lg font-[gt-regular] text-black" >
                                    ...
                                    <div className="p-2 w-full">
                                        <div className="relative">
                                            <label htmlFor="message" className="leading-7 text-lg font-[gt-regular] text-black" >
                                                Message
                                            </label>
                                    ...
                                    <div className="p-2 w-full mt-2 mb-4">
                                        ...
                                        <button type="submit" className="bg-[#ec7a48] text-white border-none rounded px-4 py-2 gap-3">
                                            Continue
                                        </button>
                                    </div>
                                </form>
