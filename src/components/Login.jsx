                                            ...
                                            <div className="text-align-center-2">
                                                <div className="max-width-large align-center">
                                                    <div className="margin-bottom margin-small">
                                                        <h1 className="heading-style-h3-2 text-align-left">Register with
                                                            AYC</h1>
                                                    </div>
                                                    <div className="margin-bottom margin-small">
                            ...
                            <div className="login-form-block w-form">
                                <form onSubmit={signInWithEmail} id="wf-form-Log-in-Form-7"
                                    ...
                                    <div className="form-field-wrapper">
                                        ...
                                        <input className="input-form w-input" style={{color: "black"}} maxLength="256"
                                               name="email"
                                    ...
                                    <div id="w-node-_297f275c-c970-4b99-5b1d-a5f8dee44df4-1feb9fb7"
                                        ...
                                        <a onClick={signInWithGoogle} disabled={isSubmitting}
                                           id="w-node-_297f275c-c970-4b99-5b1d-a5f8dee44df6-1feb9fb7" href="#"
                                ...
                                <div className="margin-top margin-small">
                                    <div className="text-align-center-2">New User? <Link to={'/register'}
