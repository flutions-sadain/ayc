...
function Home() {
    const initialFruits = ["Python", "Java", "React", "Angular", "Rust"];
            ...
            <div className="bg-white">
                <motion.div>
                    <Navbar classNames={{
                        ...
                        <NavbarContent>
                            <NavbarBrand className="max-w-md">
                                <Link to="/">
                            ...
                            <div className="mx-auto min-w-full lg:mr-0">
                                <div className="mx-auto min-w-full lg:mr-0">
                                    <div className="relative min-w-full place-items-center p-40">
                                        ...
                                        <div
                                            className="mt-10 space-y-8 border-t border-gray-200 pt-10 sm:mt-16 sm:pt-16">
                                        </div>
                                        ...
                                        <div className="mx-auto max-w-full">
                                            ...
                                            <label
                                                className="flex w-full cursor-pointer appearance-none items-center justify-center rounded-md border-1.5 border-dashed border-gray-200 p-6 transition-all hover:border-slate-400">
                            ...
                            <div className="mx-auto min-w-full lg:mr-0">
                                <div className="relative min-w-full place-items-center p-40">
                                    ...
                                    <div className="flex flex-col gap-4">
                                        ...
                                        <div className="flex w-full flex-wrap md:flex-nowrap gap-4">
                                            <DatePicker label="Position Start date"/>
                                            <DatePicker label="Position End date"/>
                                        </div>
                                        <div className="flex w-full flex-wrap md:flex-nowrap gap-4">
                                    ...
                                    <div className="flex flex-col gap-4">
                                        ...
                                        <div className="flex w-full flex-wrap md:flex-nowrap gap-4">
                                            ...
                                            <div className="relative space-y-2 w-full">
                                                <label htmlFor="hs-vertical-checkbox-in-form"
                                                ...
                                                <label htmlFor="vertical-checkbox-checked-in-form"
                                                       className="flex p-3 w-full bg-white border border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400">
                                                    <input type="checkbox"
                                                           className="shrink-0 mt-0.5 border-gray-200 rounded text-blue-600 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-800 dark:border-neutral-700 dark:checked:bg-blue-500 dark:checked:border-blue-500 dark:focus:ring-offset-gray-800"
                                                           id="vertical-checkbox-checked-in-form" checked=""/>
                                                    <span
