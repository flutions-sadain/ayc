                        ...
                        <div className="navigation-container">
                            ...
                            <div className="navigation-main mt-4">
                                ...
                                <nav role="navigation" className="nav-menu w-nav-menu">
                                    ...
                                    <button onClick={() => switchComponent('resumes')}
                                            className="navbar-link w-nav-link">Resumes
                                    </button>
                                        ...
                                        <div className="margin-bottom margin-medium">
                                            <div className="footer3-details-wrapper">
                                                <div className="text-size-small-2">‍<span
                                                    className="text-weight-semibold">Address</span>
                                                    <a href="#" className="link-2"><br/>P.O Box 2345, Bedford Dr,
                                                        Kingston<br/>New York 12401</a>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="margin-bottom margin-medium">
