...
const EnterpriseOnboarding = () => {
  ...
  const fetchCountries = async () => {
    try {
      ...
      setCountries(data);
      const selectedCountry = data.find(country => country.name === userDetails.country);
      if (selectedCountry) {
  ...
  const companySize = [
    { label: "I'm a contractor / freelancer", value: "I'm a contractor / freelancer" },
    { label: "1-199", value: "1-199" },
  ...
  const jobLevel = [
    ...
    { label: "VP", value: "VP" },
    { label: "Director / Sr", value: "Director / Sr" },
    { label: "Manager", value: "Manager" },
    { label: "Individual Contributor", value: "Individual Contributor" },
  ]

  return (
    <div className="relative bg-gradient-to-bl from-primary via-transparent">

      <div className='section-hero home'>
        <Header />
        <div className="w-auto lg:max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
          <div className="grid items-start grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
            <div>
              <p className="inline-block text-sm font-medium bg-clip-text bg-gradient-to-l from-blue-600 to-violet-500 text-transparent">AYC: A vision for 2024</p>
              <div className="mt-4 md:mb-12 max-w-2xl">
                <h1 className="mb-4 font-semibold text-gray-800 text-4xl lg:text-5xl">Welcome to AYC's Enterprise Onboarding</h1>
                <p className="text-gray-600">Welcome to AYC's Enterprise Onboarding Platform. At AYC, we specialize in transforming your hiring process with cutting-edge technologies. Our comprehensive suite of services includes advanced resume filtering, detailed candidate assessments, and immersive interview simulations. Whether you're a startup or a multinational corporation, AYC equips you with the tools to make informed hiring decisions swiftly and confidently. Join us today to experience seamless onboarding and elevate your recruitment strategy.</p>
              </div>
              <div className="mt-6 md:mt-12 py-3 flex flex-wrap items-center text-sm text-gray-800 gap-1">
                <span className="font-semibold bg-clip-text bg-gradient-to-l from-blue-600 to-violet-500 text-transparent">10,000 </span> individuals and companies trust AYC
              </div>
            ...
            <div>
              <form>
                <div className="lg:max-w-2xl lg:mx-auto lg:me-0 ms-auto">
                  <div className="p-4 sm:p-7 flex flex-col bg-white rounded-2xl shadow-lg">
                    <div className="text-center">
                      <h1 className="block text-2xl font-bold text-gray-800">Start Your Journey with AYC</h1>
                      <p className="mt-2 text-sm text-gray-600">
                        Complete the Onboarding Process to Access Our Services
                      </p>
                    </div>
                    ...
                    <div className="mt-5">
                      <div>
                        ...
                        <h2 className="text-lg font-bold tracking-tight text-gray-900 sm:text-2xl pb-5">Enterprise Information</h2>
                        <div className="flex flex-col gap-4">
                          ...
                          <div className="flex w-full flex-wrap md:flex-nowrap gap-4">
                            <Input
                              ...
                              type="tel"
                              status={userDetails?.phone?.length === 12 ? 'success' : 'default'}
                            />
                          </div>
                          <div className="flex w-full flex-wrap md:flex-nowrap gap-4">
                            <Select
                          ...
                          <div className="flex w-full flex-wrap md:flex-nowrap gap-4">
                            <Textarea
                              label="What are your organization's training needs? (Optional)"
                              aria-label="training needs"
                              placeholder=""
                              onChange={(e) => handleChange("description", e.target.value)}
                            />
                          </div>
                          <div className=" mt-5 flex w-full flex-wrap md:flex-nowrap gap-4">
                            <Checkbox >
                              I accept the <a className="text-blue-600 decoration-2 hover:underline font-medium" href="#">Terms and Conditions</a>
                            </Checkbox>
                          </div>

                          <div className="flex gap-2 sm:gap-4 mt-5 items-center">
                            <button type="button" onClick={() => navigate('/enterprise')} className="flex w-full justify-center rounded-md bg-black text-white px-3 py-3 text-sm font-semibold leading-6 shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2">
                              Submit
                            </button>
                          </div>
                        </div>
